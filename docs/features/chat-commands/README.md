...
- [ ] `docs/research/chat-commands.md` — which commands each group may use, the
      `@`-is-chat finding, and the three protocol traps, so the next person does
      not re-read `atcommand.cpp`
