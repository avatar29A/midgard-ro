// Package jobs provides the client job names shared by UI and developer tools.
package jobs
...
// Name returns the job class name from the job ID.
func Name(jobID uint16) string {
